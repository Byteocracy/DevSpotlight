...
const registerUser = asyncHandler(async(req, res) => {
    ...
    const createdUser = await User.findById(registerUser._id).selelect("-password -refreshToken");
...
const loginUser = asyncHandler(async(req, res) => {
    ...
    //check user
    const user = await User.findOne({userName, password}).selelect("-password -refreshToken");
    if(!user){
